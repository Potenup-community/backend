...
enum class StudyServiceErrorCode(
    ...
    //StudyRecruitment
    NOT_RECRUITMENT_OWNER(HttpStatus.FORBIDDEN,"SR-0003","본인이 작성한 신청만 취소할 수 있습니다."),
    LEADER_CANNOT_LEAVE(HttpStatus.BAD_REQUEST,"SR-0004","스터디장은 탈퇴할 수 없습니다."),
    TRACK_MISMATCH(HttpStatus.BAD_REQUEST,"SR-0005","신청자의 과정과 스터디의 과정이 일치하지 않습니다."),
    STUDY_NOT_RECRUITING(HttpStatus.BAD_REQUEST,"SR-0006","해당 스터디는 모집중이 아닙니다."),
    ALREADY_APPLIED(HttpStatus.BAD_REQUEST,"SR-0007","이미 신청하거나 승인된 스터디입니다."),
    RECRUITMENT_NOT_FOUND(HttpStatus.NOT_FOUND,"SR-0008","해당 스터디에 대한 신청기록을 찾을 수 없습니다."),
    STUDY_MONTH_IS_NOT_CURRENT_MONTH(HttpStatus.BAD_REQUEST,"SR-0009","신청한 차수는 현재 진행되는 차수에 해당하지 않습니다."),
    GRADUATED_STUDENT_CANT_RECRUIT_OFFICIAL_STUDY(HttpStatus.FORBIDDEN,"SR-0010","수료생은 지원할 수 없는 스터디입니다."),
    RECRUITMENT_CANCEL_NOT_ALLOWED_STUDY_NOT_PENDING(HttpStatus.CONFLICT,"SR-0011","스터디 상태가 PENDING 이 아닌 경우 신청을 취소할 수 없습니다.")
}