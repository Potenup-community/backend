...
enum class NotificationMessageVariant(
    ...
    POST_REACTION_EUNHAE(NotificationType.POST_REACTION, "♥️ + 1"),

    // ===== 답글 알림 =====
    COMMENT_REPLY_AREUM(NotificationType.COMMENT_REPLY, "내 글에 대화 이어지는 중! 🧑🏻‍❤️‍🧑🏻"),
    COMMENT_REPLY_JAKYUNG(NotificationType.COMMENT_REPLY, "응답에 응답해볼까요~!?"),
    COMMENT_REPLY_KWANGMIN(NotificationType.COMMENT_REPLY, "뭔데 이렇게 인기가 많아요?"),
    COMMENT_REPLY_EUNHAE(NotificationType.COMMENT_REPLY, "관심 폭발!💬"),
    ...
    COMMENT_REACTION_EUNHAE(NotificationType.COMMENT_REACTION, "♥️ + 1"),
    ...
    STUDY_APPLICATION_KWANGMIN(NotificationType.STUDY_APPLICATION, "스터디에 새로운 분이 추가 합류를 요청 주셨어요."),
